...
2. **Fetch Manifest** - Reads `{S3_INDEX_PREFIX}/manifest/timestamp_v1.json` from S3
...
The manifest file `{S3_INDEX_PREFIX}/manifest/timestamp_v1.json` is a JSON array of entries:
